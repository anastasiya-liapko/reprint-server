...
?>
    <li class="<?= implode(' ', $classes) ?> page-item"><a class="page-link" href="<?= ($href) ?>"><?= ($previous) ?></a></li>
<?php
        /**
...
?>
    <li class="number page-item"><a class="page-link" data-pagenumber="<?= ($current + $x - $leading) ?>" href="<?= ($href) ?>"><?= ($current + $x - $leading) ?></a></li>
<?php
            }

            // print current page
?>
    <li class="number active page-item"><a class="page-link" data-pagenumber="<?= ($current) ?>" href="#"><?= ($current) ?></a></li>
<?php
...
?>
    <li class="number page-item"><a class="page-link" data-pagenumber="<?= ($current + $x + 1) ?>" href="<?= ($href) ?>"><?= ($current + $x + 1) ?></a></li>
<?php
            }
        }
...
?>
    <li class="<?= implode(' ', $classes) ?> page-item"><a class="page-link" href="<?= ($href) ?>"><?= ($next) ?></a></li>
</ul>
<?php
    }
